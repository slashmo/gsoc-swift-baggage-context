...
It is purposefully not tied to any specific use-case (in the spirit of the Tracing Plane paper's BaggageContext), however does not implement its own serialization scheme (today), however should enable vast majority of use cases cross-cutting tools need to support.
